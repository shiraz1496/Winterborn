...
| --- | --- |
| **Flat-item migration orphaning sales history** | Highest technical risk. Mitigated by the blocker-gate prototype. Three hours to de-risk the project's headline value. |
