...
function NewRequestBody() {
  ...
  return (
    <div>
      ...
      {/* Packing-list suggestion (CEO ask, 2026-09-01). Sits above manual
          search so an operator can either kick off from a suggestion and
          then refine, or ignore it entirely and build the list by hand. */}
      <div className="suggest-panel">
        <div className="suggest-panel-header">
          <span className="suggest-panel-icon" aria-hidden="true">
            {/* sparkles — signals "smart / generated" without leaning on emoji */}
